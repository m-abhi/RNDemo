...
class ResetPasswordScreen extends React.Component {
  ...
  state = {
    showOldPasswordField: this.props.route.params.showOldPasswordField,
    oldPassword: '',
    newPassword: '',
    confirmPassword: ''
  }
  ...
  isValid = () => {
    if (this.state.showOldPasswordField && this.state.oldPassword == "") {
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        />
        {
          this.state.showOldPasswordField ? <TextInput
            ...
            value={this.removeEmojis(this.state.oldPassword)}
          /> : null
        }
        ...
        <TextInput
          ...
          value={this.removeEmojis(this.state.newPassword)}
        />
