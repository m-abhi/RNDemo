...
import { Image, Text, StyleSheet, View, TextInput, TouchableOpacity, SafeAreaView, ScrollView } from 'react-native';
// Special Characters
const specials = /[`~!@#$%^&*()_|+\-=?;:'",.<>\{\}\[\]\\\/]/gi;
...
class SignupScreen extends React.Component {
  constructor(props) {
    ...
    this.removeSpecialChars = this.removeSpecialChars.bind(this);
  }
  state = {
    firstName: '',
    lastName: '',
  ...
  handleCountryCode = (text) => {
    this.setState({ countryCode: text.replace(/\s/g, '') })
  }
  handlePhone = (text) => {
  ...
  isValid = () => {
    ...
    if (this.state.firstName == "") {
      ...
      return false
    } else if (!specials.test(this.state.phone)) {
      ...
      alert('Emojis are not allowed in password')
      return false
        ...
        <ScrollView contentContainerStyle={styles.ScrollView}>
          <View style={styles.container}>
            ...
            <TextInput
              ...
              value={this.removeSpecialChars(this.state.firstName)}
            />
            ...
            <TextInput
              ...
              value={this.removeSpecialChars(this.state.lastName)}
            />
            ...
            <TextInput
              ...
              value={this.removeSpecialChars(this.state.phone)}
            />
            ...
            <TextInput
              ...
              value={this.removeEmojis(this.state.confirmPassword)}
            />
            ...
            <TouchableOpacity
              ...
              <Text style={styles.textCaps}> Signup </Text>
            </TouchableOpacity>
            ...
            <View style={styles.horizontalView}>
              ...
              <TouchableOpacity
                ...
                <Text style={styles.textColored}> Login </Text>
              </TouchableOpacity>
            </View>
